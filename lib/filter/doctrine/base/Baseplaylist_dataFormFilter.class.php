...
/**
 * playlist_data filter form base class.
 *
 * @package    RSSMonitor
 * @subpackage filter
 ...
 */
abstract class Baseplaylist_dataFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('playlist_data_filters[%s]');
