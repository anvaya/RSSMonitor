 ...
 * @method integer       getRssDataId()         Returns the current record's "rss_data_id" value
 ...
 * @method scan_song     setRssDataId()         Sets the current record's "rss_data_id" value
...
abstract class Basescan_song extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('rss_data_id', 'integer', 5, array(
             'type' => 'integer',
             'size' => 5,
             'notnull' => false,
             'length' => 5,
